  ...
  return (
    <div className=" w-full font-montserrat text-sm">
      ...
      <div className="2xl:container mx-auto  md:px-10 lg:px-20">
        ...
        <div className=" flex">
          <Profile />
          <div className="container overflow-auto md:h-[800px] lg:w-[70%] scrollbar-hide">
            <div >
              {postLoading ? (
                              ...
                              <button
                                ...
                                className={
                                  postCommentId !== item.postId
                                    ...
                                    : "bg-[rgb(0,0,0,0.04)] px-5 py-2 rounded-md text-sm flex justify-between items-center b border-2 border-[#353bc1] "
                                }
                              >
